...
class ReverseTrailerBotMPCNode(Node, AStar):
    def __init__(self, mpc_controller: MPC):
        Node.__init__(self, "reverse_trailerbot_mpc_node")
        AStar.__init__(self)
        ...
        self.goal_pos = Pos(x=0.0, y=5.0, theta=0.0, phi=0.0)
    ...
    def control_loop(self):
        ...
        # self._update_goal_from_path() #TODO: Uncomment later
